...
left_arm_torso_init_joint_value = [0.0, 2.193856910816974, 1.1630675621113802, 0.852437058039672, 1.113211995331904, 0.8438088567310283, -1.0094747189949542, 0.24438780016629988];
right_arm_torso_init_joint_value = [0.0, 2.5794765930828296, 1.3620727097356629, 1.3831275005664025, 0.7845256389316293, -3.057076564078304, -1.7625990915019676, 1.3096307216010097];
...
def generate_goal_points(Bin_base_x, Bin_base_y, Bin_base_z, using_torso = False):
    ...
    binK.x = Entry_X_shiftvalue - Custom_defined_distance;
    binK.y = Bin_base_y;
